...
/**
 * Wraps an <tt>org.apache.commons.logging.Log</tt> for Persistit logging. Code
 * to enable default logging through Apache commons logging is shown here:
 * <code><pre>
...
public class ApacheCommonsLogAdapter extends AbstractPersistitLogger {
     ...
     * 
     * @param log
     *            A <tt>Log</tt> to which Persistit log messages will be
     *            directed.
     */
    ...
    /**
     * Writes a log message generated by Persistit to the wrapped <tt>Log</tt>.
     * 
     * @param lt
     *            The <tt>LogTemplate</tt>
     * @param message
