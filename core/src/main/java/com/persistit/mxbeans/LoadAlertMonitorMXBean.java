...
@MXBean
public interface LoadAlertMonitorMXBean {
    
    public final static String NAME = "LoadAlertMonitor";

    public final static String MXBEAN_NAME = "com.persistit:type=Persistit,class=LoadAlertMonitor";
    
    /*
     * Note: the following methods are copied from AlertMonitor because the default MXBean
     * mechanism only exposes methods declared in this class.
     */
