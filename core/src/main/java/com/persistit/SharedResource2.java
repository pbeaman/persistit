...
class SharedResource2 {
    ...
    private static class Sync extends AbstractQueuedSynchronizer {
        ...
        /**
         * Attempt to convert shared to exclusive.  The caller must already
         * have acquired shared access. This method upgrades the state to
         * exclusive, but only if there is exactly one shared acquire.
         * @return
         */
    ...
    void releaseWriterClaim() {
        ...
        // tryDowngrade actually increments the acquirer count, allowing
