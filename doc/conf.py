...
# to format substitutions directly, but could have more uses.
rst_epilog = """
.. |jar_file_name| replace:: ``{0}-{1}.jar``
.. |zip_file_name| replace:: ``{0}-{1}.zip``
.. |tar_file_name| replace:: ``{0}-{1}.tar.gz``
.. |unpack_zip_cmd| replace:: ``jar -xvf {0}-{1}.zip``
.. |unpack_tar_cmd| replace:: ``tar -xzf {0}-{1}.tar.gz``
""".format("akiban-persistit", release)
...
latex_documents = [
  ('index', 'Persistit.tex', u'Persistit Documentation',
...
man_pages = [
    ('index', 'persistit', u'Persistit Documentation',
...
texinfo_documents = [
  ('index', 'Persistit', u'Persistit Documentation',
   u'Akiban Technologies', 'Persistit', 'One line description of project.',
   'Miscellaneous'),
]
