 ...
 * new instance of the object.  All objects in this collection must extend
 * the inner class InternalHashSet.Entry.
 * 
 * @author pbeaman
 * @version 1.0
 */
class InternalHashSet
{
    ...
    Entry next(Entry entry)
    {
        ...
        else
        {
            ...
            {
                if (_entries[index] != null) return _entries[index];
            }
            return null;
        }
    }
