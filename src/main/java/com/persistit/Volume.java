...
public class Volume {
    ...
    static Volume createTemporaryVolume(final Persistit persistit, final int pageSize, final File tempDirectory) throws PersistitException {
    ...
    void openTemporary(final Persistit persistit, final int pageSize, final File tempDirectory) throws PersistitException {
        checkClosing();
        if (_storage != null) {
            throw new IllegalStateException("This volume has already been opened");
        }
