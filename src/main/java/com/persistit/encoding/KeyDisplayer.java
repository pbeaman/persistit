 ...
 * <tt>KeyDisplayer</tt>, if present, to generate a String representation
 * of an object value encoded in a <tt>Key</tt>.
 * </p>
 * @version 1.0
 */
public interface KeyDisplayer
extends KeyCoder
{
    /**
     * <p>
     ...
     */
    public void displayKeySegment(Key key, StringBuffer target, Class clazz, CoderContext context)
    throws ConversionException;
