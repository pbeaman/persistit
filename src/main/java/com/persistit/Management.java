 ...
 * performance metrics and resources within Persistit that are not exposed 
 * by the normal access methods. For example, this class provides methods 
 * that enumerate the volumes currently mounted, the size and effectiveness 
 * of buffer pool components, and many other items that
...
extends Remote
{
     ...
     * on invocation of {@link com.persistit.Persistit#close}.
     * This flag is intended for use by management tools that need to keep
     * Persistit open even when the application has requested it to close so
     * that the final state of the Persistit environment can be examined.
     * 
    ...
    /**
     * Controls whether Persistit will suspend its shutdown activities
     * on invocation of {@link com.persistit.Persistit#close}.
     * This flag is intended for use by management tools that need to keep
     * Persistit open even when the application has requested it to close so
     * that the final state of the Persistit environment can be examined.
     * 
     * @param suspended  <tt>true</tt> to specify that Persistit will wait
     ...
     * 
     * @param pageAddress   The page addres
     * 
     * @return  the array   Array of <tt>RecordInfo</tt> objects containing
     *                      detailed information about the records on the
     *                      specified page.
     */
     ...
     * specifies a <tt>KeyFilter</tt> to be applied when taversing records.
     * The supplied <tt>fromKey</tt> specifies a starting key value, and is non-
     * inclusive.
     * </p>
     * <p>
     * Each <tt>LogicalRecord</tt> object returned by this method optionally
     * contain decoded String representations of the record's key and value.
     * If <tt>decodeString</tt> is <tt>true</tt> then each 
     * <tt>LogicalRecord</tt>'s <tt>KeyState</tt>, <tt>KeyString</tt> and 
     * <tt>ValueString</tt> properties are set to String values resulting
     * from decoding the underlying key and value in the context of the 
     * running Persistit instance. Otherwise, <tt>KeyString</tt> and 
     * <tt>ValueString</tt> are <tt>null</tt>. Applications that display
     * String-valued representations of a record's key and value should
     * typically enable <tt>decodeString</tt> so that any required
     * {@link com.persistit.encoding.KeyCoder} or 
     * {@link com.persistit.encoding.ValueCoder} objects are
     * referenced in the context of the running Persistit instance, not
     * an RMI client.  
     * </p>
     * 
     * @param volumeName        The volume name
     ...
     * 
     * @param keyFilterString   If non-<tt>null</tt>, specifies the String
     *                          representation of a {@link KeyFilter}. 
     *                          Only records having key values selected by 
     ...
     * 
     * @param maxRecordCount    Maximum number of LogicalRecord objects to
     *                          return
     * 
     * @param maxValueBytes     Maximum encoded size of each Value object.
     * 
     * @param decodeStrings     If <tt>true</tt>, decode each 
     *                          <tt>LogicalRecord</tt>'s <tt>Key</tt> and 
     *                          <tt>Value</tt> as Strings.
     * 
    ...
    /**
     * <p>
     * Counts the the number of records that could be traversed given
     * a starting key value in a tree specified by <tt>volumeName</tt>, 
     * <tt>treeName</tt>, using an optional {@link KeyFilter}
     * specified by <tt>keyFilterString</tt>.  Records are counted by 
     * traversing forward or backward according to the Persistit 
     * <a href="Key.html#_keyOrdering">key order 
     * specification</a>. The direction of traversal is specified by
     * <tt>direction</tt>.
     * </p>
     * <p>
     ...
     * <tt>maximumCount</tt>.  It also contains a <tt>KeyState</tt> 
     * representing the value of the <tt>Key</tt> of the final record
     * traversed by this method. If the returned count is N then the
     * returned <tt>KeyState</tt> corresponds with the Nth record
     * counted.
     * </p>
     * 
     * @param volumeName        The volume name
     ...
     * @param direction         Traversal direction.
     * 
     * @param maximumCount      Maximum number of LogicalRecord objects to
     *                          traverse.
     * 
     * @return                  The traversed count, and a value of the key
     *                          associated with the last record traversed.
     * 
     * @throws RemoteException
     */
     ...
     *          <tt>keyFilterString</tt>, or -1 if the string is
     *          valid.
     *  
     * @throws  RemoteException
     */
     ...
     * <a href="Value.html#_streamMode">Stream Mode</a>, this
     ...
     * 
     * @param context       Object passed to any 
     *                      {@link com.persistit.encoding.ValueCoder} used in
     ...
     * Objects, one object per <a href="Key.html#_keySegments">
     * key segment</a>. 
     * 
     ...
     *                  the task.
     * @return          Array of <tt>TaskStatus</tt> objects indicating status
     *                  of selected task(s).
     * @throws RemoteException
     */
     ...
     * in the {@link Task#STATE_ENDED} state. If <tt>taskId</tt> is -1 then
     * these actions are applied to all tasks.
     * @param taskId    Task ID for a selected Task, or -1 for all Tasks.
     * @throws RemoteException
     */
     ...
     */
    abstract static class AcquisitionTimeBase
    ...
    implements Serializable
    {
        ...
        /**
         * Returns the count of lookup operations for pages images in this
         * pool for which the page image was already found in this
        ...
        /**
         * Get the count of dirty pages (pages that contain updates not
     ...
     * {@link #getBufferInfoArray} method to get an array of <tt>BufferInfo</tt>s
     * for <tt>Buffers</tt> in various states.
     * </p>
     * <p>
     * Note that the content of a <tt>BufferPool</tt> and the status of
     * individual <tt>Buffer</tt>s changes extremely rapidly when Persistit
     * is active.  A <tt>BufferInfo</tt> represents a snapshot of this state
    ...
    implements Serializable
    {
        ...
        /**
         * Indicates whether the page occupying this buffer is
         * a Garbage page.
         * @return  <tt>true</tt> if this is a Garbage page, 
         ...
         * Indicates whether the page occupying this buffer is
         * a Data page.
         * @return  <tt>true</tt> if this is a Data page, 
         *          otherwise <tt>false</tt>.
         */
         ...
         * Indicates whether the page occupying this buffer is
         * an Index page.
         * @return  <tt>true</tt> if this is an Index page, 
         *          otherwise <tt>false</tt>.
         */
         ...
         * Indicates whether the page occupying this buffer is
         * a LongRecord page.
         * @return  <tt>true</tt> if this is a LongRecord page, 
         *          otherwise <tt>false</tt>.
         */
         ...
         * Indicates whether the page occupying this buffer is
         * an Unallocated page.
         * @return  <tt>true</tt> if this is an Unallocated page, 
         *          otherwise <tt>false</tt>.
         */
        ...
        /**
         * Returns the name of the <tt>Thread</tt> that currently holds a
         * writer (exclusive) claim on the <tt>Buffer</tt> if there is one,
         ...
         * <tt>Buffer</tt>.  The address is an ordinal number that indicates
         * the page's position within a volume file.In a standard Volume,
         * page address <code>P</code> is located at file address 
         * <code>P * pageSize</code>. Page address 0 denotes the
        ...
        * @return  The page address.
        ...
        /**
         * Returns the full pathname of the Volume of the page occupying 
         * this buffer if there is one, otherwise returns <tt>null</tt>.
        ...
        public String displayableSummary()
        {
            return 
                "page=" + _pageAddress +
                " type=" + _typeName + 
                " rightSibling=" + _rightSiblingAddress +
                " status=" + _statusCode +
    ...
    implements Serializable
    {
        ...
        /**
         * Returns the time and date when the most recent file
         * extension occurred.
        ...
        /**
         * Returns the count of {@link Exchange#fetch} operations.  These
         * include {@link Exchange#fetchAndStore} and 
         ...
         * include {@link Exchange#next}, {@link Exchange#previous} and
        ...
        /**
         * Returns the maximum size in bytes to which this <tt>Volume</tt> 
         * may grow.
        ...
        /**
         * Tests whether the supplied object is a <tt>VolumeInfo</tt> with 
    ...
    implements Serializable
    {
        ...
        /**
         * Tests whether the supplied object is a <tt>TreeInfo</tt> with 
     ...
     * page. Used by display tools to display the contents of a tree. 
     * The method {@link #getLogicalRecordArray} method returns an array of
     ...
     * {@link #getRecordInfoArray} method returns an array of <tt>RecordInfo</tt>
     * elements for a specified page.
     */
    ...
    implements Serializable
    {
        ...
        /**
         * Returns the owner (hostname and/or username) of the initiator of
         * this task
         * @return  the owner
         */
        ...
        /**
         * Returns the name of the state this task is in.  One of
        ...
        /**
         * A short (under 40 character) readable String summarizing the 
         * current status.
        ...
        /**
         * Tests whether the supplied object is a <tt>TaskStatus</tt> with 
    ...
    /**
     * A subclass of <tt>RemoteException</tt> that wraps a <tt>Throwable</tt>
     * so that it can be returned to the remote client. 
     */
