...
import static com.persistit.JournalManager.ALMOST_URGENT;
import static com.persistit.JournalManager.URGENT;
import static com.persistit.JournalManager.URGENT_COMMIT_DELAY;
...
class JournalManager implements JournalManagerMXBean, VolumeHandleLookup {
    ...
    public int urgency() {
        ...
        int journalFileCount = (int) ((_currentAddress - _baseAddress) / _blockSize);
