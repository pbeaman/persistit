...
public interface ManagementMXBean {
    ...
    public void setIoLogFile(final String string) throws RemoteException;
     ...
     *            allowed to run
     * @param verbosity
     *            Verbosity level, one of {@link Task#LOGNORMAL} or
     *            {@link Task#LOGVERBOSE}.
     ...
     * {@link Task#STATEENDED} state. If <tt>taskId</tt> is -1 then these
