...
public class LogBase
{
    ...
    public final static int LOG_MBEAN_REGISTRATION = addLogTemplate(INFO, LIFECYCLE, "MBEAN_REGISTATION");
    public final static int LOG_MBEAN_EXCEPTION = addLogTemplate(WARNING, LIFECYCLE, "MBEAN_EXCEPTION");
    final static int LOG_UNRESERVED_DIRTY = addLogTemplate(FINE, POOL, "UNRESERVED_DIRTY");
    final static int LOG_PWJ = addLogTemplate(FINER, PERSISTIT, "PWJ");
    final static int LOG_RETRY_FAIL_SEARCH = addLogTemplate(WARNING, PERSISTIT, "RETRY_FAIL_SEARCH");
    final static int LOG_RETRY_FAIL_STORE = addLogTemplate(WARNING, PERSISTIT, "RETRY_FAIL_STORE");
    final static int LOG_RETRY_FAIL_REMOVE = addLogTemplate(WARNING, PERSISTIT, "RETRY_FAIL_REMOVE");
    final static int LOG_RETRY_FAIL_REMOVE_REINDEX = addLogTemplate(WARNING, PERSISTIT, "RETRY_FAIL_REMOVE_REINDEX");
    final static int LOG_RETRY_FAIL_DEALLOC = addLogTemplate(WARNING, PERSISTIT, "RETRY_FAIL_DEALLOC");
    final static int LOG_RETRY_FAIL_COMMIT = addLogTemplate(WARNING, PERSISTIT, "RETRY_FAIL_COMMIT");
    ...
    final static int LOG_STARTED = addLogTemplate(FINE, PWJ, "STARTED");
    final static int LOG_NEWGEN = addLogTemplate(FINER, PWJ, "NEWGEN");
    final static int LOG_UNRESERVE = addLogTemplate(FINEST, PWJ, "UNRESERVE");
    final static int LOG_CLOSE1 = addLogTemplate(FINER, PWJ, "CLOSE1");
    final static int LOG_CLOSE2 = addLogTemplate(FINER, PWJ, "CLOSE2");
    final static int LOG_ENSUREWRITTEN1 = addLogTemplate(FINE, PWJ, "ENSUREWRITTEN1");
    final static int LOG_ENSUREWRITTEN2 = addLogTemplate(FINE, PWJ, "ENSUREWRITTEN2");
    final static int LOG_WAIT_PREV_GEN1 = addLogTemplate(FINER, PWJ, "WAIT_PREV_GEN1");
    final static int LOG_WAIT_PREV_GEN2 = addLogTemplate(FINER, PWJ, "WAIT_PREV_GEN2");
    final static int LOG_COMMITTED = addLogTemplate(FINER, PWJ, "COMMITTED");
    final static int LOG_RESERVE1 = addLogTemplate(FINER, PWJ, "RESERVE1");
    final static int LOG_RESERVE2 = addLogTemplate(FINER, PWJ, "RESERVE2");
    final static int LOG_RESERVE3 = addLogTemplate(FINER, PWJ, "RESERVE3");
    final static int LOG_GEN_CLOSED = addLogTemplate(FINE, PWJ, "GEN_CLOSED");
    final static int LOG_COPY1 = addLogTemplate(FINER, PWJ, "COPY1");
    final static int LOG_COPY2 = addLogTemplate(FINER, PWJ, "COPY2");
    final static int LOG_COPY3 = addLogTemplate(FINER, PWJ, "COPY3");
    final static int LOG_COPY_NOTDIRTY = addLogTemplate(FINER, PWJ, "COPY_NOTDIRTY");
    final static int LOG_COMMIT1 = addLogTemplate(FINER, PWJ, "COMMIT1");
    final static int LOG_COMMIT2 = addLogTemplate(FINER, PWJ, "COMMIT2");
    final static int LOG_COMPLETED = addLogTemplate(FINER, PWJ, "COMPLETED");
    final static int LOG_WRITEPAGE1 = addLogTemplate(FINEST, PWJ, "WRITEPAGE1");
    final static int LOG_WRITEPAGE2 = addLogTemplate(FINEST, PWJ, "WRITEPAGE2");
    final static int LOG_MARK1 = addLogTemplate(FINER, PWJ, "MARK1");
    final static int LOG_MARK2 = addLogTemplate(FINER, PWJ, "MARK2");
    final static int LOG_WRITE_BLOCKED_PAGE = addLogTemplate(FINER, PWJ, "WRITE_BLOCKED_PAGE");
    final static int LOG_LATER_COMMIT = addLogTemplate(FINER, PWJ, "LATER_COMMIT");
    final static int LOG_KICK1 = addLogTemplate(FINER, PWJ, "KICK1");
    final static int LOG_KICK2 = addLogTemplate(FINER, PWJ, "KICK2");
    final static int LOG_RESET = addLogTemplate(FINE, PWJ, "RESET");
    final static int LOG_WAIT1 = addLogTemplate(FINER, PWJ, "WAIT1");
    final static int LOG_WAIT2 = addLogTemplate(FINER, PWJ, "WAIT2");
    final static int LOG_WAIT3 = addLogTemplate(FINER, PWJ, "WAIT3");
    final static int LOG_CLOSED = addLogTemplate(FINE, PWJ, "CLOSED");
    final static int LOG_WRITE1 = addLogTemplate(FINER, PWJ, "WRITE1");
    final static int LOG_WRITE2 = addLogTemplate(FINER, PWJ, "WRITE2");
    ...
    final static int LOG_EXTEND_BADLENGTH = addLogTemplate(SEVERE, POOL, "EXTEND_BADLENGTH");
    ...
    final static int LOG_UNINDEXED_PAGE = addLogTemplate(INFO, PERSISTIT, "UNINDEXED_PAGE");
    ...
    {
        if ((messageId & 0xFF) < _minimumLogLevel) return false;
    ...
    {
        if ((messageId & 0xFF) < _minimumLogLevel) return;
        
        _persistit.getPersistitLogger().log(
    ...
    void log(int messageId, Object p0)
    {
        ...
        _persistit.getPersistitLogger().log(
                logTemplate(messageId),
                p0, null, null, null, null, null, null, null, null, null);
    }
    ...
    void log(int messageId, Object p0, Object p1)
    {
        ...
        _persistit.getPersistitLogger().log(
                logTemplate(messageId),
                p0, p1, null, null, null, null, null, null, null, null);
    }
    ...
    void log(int messageId, long p0)
    {
        ...
        _persistit.getPersistitLogger().log(
                logTemplate(messageId),
                Long.toString(p0), null, null, null, null,
    ...
    void log(int messageId, long p0, long p1)
    {
        ...
        _persistit.getPersistitLogger().log(
                logTemplate(messageId),
                Long.toString(p0), Long.toString(p1), null, null, null,
                null, null, null, null, null);
    }
        ...
        Object p5, Object p6, Object p7, Object p8, Object p9)
    {
        ...
        _persistit.getPersistitLogger().log(
            ...
            Long.toString(p3),Long.toString(p4),
            p5, p6, p7, p8, p9);
    }
    ...
    private int lookup(String[] array, String s)
    {
        ...
        {
            if (array[i] != null && array[i].equalsIgnoreCase(s)) return i;
        }
        return -1;
    }
    ...
    protected static int addLogTemplate(int level, int subsystem, String template)
    {
        ...
        try
        {
            ...
            {
                _logBundle =
                    ResourceBundle.getBundle(THIS_CLASS_NAME);
            }
            if (_logBundle != null)
            {
                try
                {
                    ...
                    if (translatedTemplate != null) template = translatedTemplate;
                }
    ...
    public void setLogEnabled(String flags, int baseLevel)
    throws Exception
    {
        ...
        while (st1.hasMoreTokens())
        {
            ...
            if (subsystem == -1 || level == -1)
            {
                throw new IllegalArgumentException(
                    "Bad log level specifaction \"" + s + 
                    "\" in \"" + flags + "\"");
            }
            long typeMask = 0;
            if (subsystem == 0) typeMask = -1;
            else if (subsystem > 0) typeMask = 1 << (subsystem - 1);
    ...
    public void setEnabled(long typeMask, int level)
    {
        for (int i = 0; i < _templateArray.length; i++)
        {
            ...
            if (lt != null)
            {
                if ((lt.getType() & typeMask) != 0 &&
                    lt.getLevel() >= level)
                {
                    lt.setEnabled(true);
                    if (level < _minimumLogLevel) _minimumLogLevel = level;
                }
            }
        }
    }
