 ...
 * either have a registered {@link com.persistit.encoding.KeyCoder} or it
 * must be one of the types having built-in encoding.  See {@link Key}
 * for information on how objects are translated to persistent key values.
 * </p>
 * <p>
...
public class PersistitIndexedSet
{
     ...
     * The <tt>Exchange</tt> may be changed by the caller after being used
     * in this constructor.
     *  
     * @param exchange
     */
    ...
    /**
     * Allocates an <tt>Exchange</tt> from the Exchange pool. Be sure to
     ...
     */
    private Exchange allocateExchange()
    throws PersistitException
    {
        Exchange exchange =
            _persistit.getExchange(_tree.getVolume(), _tree.getName(), false);
     ...
     * @param id        The OID
     * 
     * @return          <tt>true</tt> if there is an object associated with this
     *                  ID; otherwise <tt>false</tt>.
     * 
     * @throws PersistitException
     */
     ...
     * 
     * @return          <tt>true</tt> if there is an equivalent object; 
     ...
     * @param id        The OID
     * 
     * @return          The associated Object, or <tt>null</tt> if there is
     *                  none.
     * @throws PersistitException
     */
     ...
     * @param object    The Object
     * @return          The object ID, or -1 if the Object is currently not
     *                  represented in the index.
     * @throws PersistitException
     */
    public long lookup(Object object)
    throws PersistitException
    {
        Exchange exchange = allocateExchange();
        exchange.append("key").append(object).fetch();
    ...
    /**
     * Puts an <tt>Object</tt> into the index.  If there already is an
     * equivalent object, the stored copy is updated to reflect the state of
     * the supplied object.  Otherwise the object is associated with a
     * newly allocated object ID.  The equivalence of stored objects is
     * determined by whether the {@link Key} values they generate are the same.
     * 
     * @param object    The <tt>Object</tt> to store or update
     * 
     * @return          The OID
     * 
     * @throws PersistitException
     ...
     * exist in the indexed set.  This method permits changing an object
     * in such a way its encoded {@link Key} value changes. If the new object
     * value results in a different <tt>Key</tt> value, this method
     * removes the prior entry and inserts the new one.
     * 
     * @param id            The OID
     * 
     * @param newValue      The new value to be associated with this OID
     * 
     * @return              <tt>true</tt> if the new object is indexed under
     *                      a different key value then the old one;
     *                      otherwise <tt>false</tt>
     * 
     * @throws PersistitException
     */
