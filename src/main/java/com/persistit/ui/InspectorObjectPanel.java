...
extends AbstractInspector
{
    ...
    protected void setup(AdminUI ui, InspectorPanel host)
    {
        ...
        final JScrollPane textScrollPane =
            new JScrollPane(
            _textArea,
            JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
            JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        ...
        _tree.getSelectionModel().addTreeSelectionListener(
            new TreeSelectionListener()
            {
                ...
                {
                    final ValueInspectorTreeNode node =
                        (ValueInspectorTreeNode)tse
                            .getPath()
    ...
    protected void refreshed()
    {
        ...
        else if (_host.isShowValue())
        {
            ...
            {
                Object[] results =
                    management.decodeValueObjects(
                        valueState, 
                        null);
                ValueInspectorTreeNode root =
