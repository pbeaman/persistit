...
public class Stress8txn extends StressBase {
    ...
    public void setupTest(final String[] args) {
        _ap = new ArgParser("com.persistit.Stress8txn", args, ARGS_TEMPLATE);
    ...
    private class Operation2 extends Operation {
        ...
        public void runTransaction() throws PersistitException {
            ...
            if (valueB != totalC) {
                _result =
                    new Result(false, "totalC=" + totalC + " valueB=" + valueB
                        + " at " + _exs);
            }
        }
    }
    ...
    private class Operation3 extends Operation {
        ...
        public void runTransaction() throws PersistitException {
            ...
            if (valueA != totalB) {
                _result =
                    new Result(false, "totalB=" + totalB + " valueA=" + valueA
                        + " at " + _exs);
            }
        }
    }
    ...
    private class Operation4 extends Operation {
        ...
        public void runTransaction() throws PersistitException {
            ...
            if (totalA != 0) {
                _result = new Result(false, "totalA=" + totalA + " at " + _exs);
            }
        }
    }
    ...
    private boolean totalConsistencyCheck() throws PersistitException {
        ...
        while (exa.next()) {
            ...
            while (exb.next()) {
                ...
                if (totalC != valueB) {
                    _result =
                        new Result(false, "totalC=" + totalC + " valueB="
                            + valueB + " at " + exb);
                    forceStop();
                    return false;
                }
        ...
        if (totalA != 0) {
            _result = new Result(false, "totalA=" + totalA + " at " + exa);
            forceStop();
            return false;
        }
        return true;
