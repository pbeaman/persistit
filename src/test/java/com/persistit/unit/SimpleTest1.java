...
public class SimpleTest1 extends PersistitTestCase {
    
    private static String[] _args = new String[0];

    private String _volumeName = "persistit";
    
    public void test0() throws PersistitException {
        System.out.print("test0 ");
        final Exchange exchange =
            _persistit.getExchange(_volumeName, "SimpleTest1", true);
    ...
    public void test3() throws PersistitException {
        ...
        final Exchange exchange =
            _persistit.getExchange(_volumeName, "SimpleTest1", false);
        final StringBuffer sb = new StringBuffer();
        for (int i = 1; i < 400; i++) {
            sb.setLength(0);
            sb.append((char) (i % 20 + 64));
    ...
    public void test4() throws PersistitException {
        ...
        final Exchange exchange =
            _persistit.getExchange(_volumeName, "SimpleTest1LongRecord", true);
    ...
    public void test5() throws PersistitException {
        ...
        final Exchange exchange =
            _persistit.getExchange(_volumeName, "SimpleTest1LongRecord", false);
        exchange.getValue().setMaximumSize(32 * 1024 * 1024);
        final StringBuffer sb = new StringBuffer();
    ...
    public void test6() throws PersistitException {
        ...
        final Exchange exchange =
            _persistit.getExchange(_volumeName, "SimpleTest1BadSplit", true);
        exchange.removeAll();
    ...
    public void test8() throws PersistitException {
        ...
        final Exchange exchange =
            _persistit.getExchange(_volumeName, "SimpleTest1BadStoreOverLengthRecord",
                true);
        exchange.removeAll();
        final Key key = exchange.getKey();
        final Value value = exchange.getValue();
